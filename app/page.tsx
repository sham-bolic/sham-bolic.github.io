	...
	const HomeSection = () => {
		...
		return (
			<section
				id="home"
				ref={ref}
				className="min-h-screen flex items-center justify-center relative py-20 md:py-32 px-4"
			>
				...
				<div className="relative z-10 text-center max-w-4xl mx-auto">
					...
					<div className="flex justify-center flex-wrap gap-4">
						...
						<a
							href="#contact"
							className="px-8 py-3 rounded-full font-semibold text-neutral-700 border-2 border-neutral-300 bg-white transition-all duration-300 hover:bg-neutral-50 hover:border-neutral-400"
						>
							Get In Touch
						</a>
					</div>
		...
		return (
			<section id="experience" ref={ref} className="py-20 md:py-32 bg-white">
				<div className="container mx-auto px-4 max-w-7xl">
					...
					<div
						className={`timeline relative md:border-l-2 border-neutral-200 md:pl-8 ${animationClasses}`}
					>
									...
									<div className="card p-8 hover:shadow-xl transition-all duration-300">
										<div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 mb-4">
											<div className="flex-1">
												<div className="text-sm text-warm-600 mb-2 font-semibold uppercase tracking-wider">
													{job.date}
												</div>
												<h3 className="text-xl lg:text-2xl font-bold text-neutral-900 font-serif mb-1">
													{job.title}
												</h3>
												<p className="text-lg font-medium text-neutral-600 italic">
													{job.company}
												</p>
											</div>
						...
						{education.map((edu, index) => (
							...
							>
								...
								<div className="card p-8 hover:shadow-xl transition-all duration-300">
									<div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 mb-4">
										<div className="flex-1">
											<div className="text-sm text-accent-600 mb-2 font-semibold uppercase tracking-wider">
												{edu.years}
											</div>
											<h3 className="text-xl lg:text-2xl font-bold text-neutral-900 font-serif mb-1">
												{edu.institution}
									...
									<div className="mt-6">
										...
										<div className="grid grid-cols-1 md:grid-cols-2 gap-2">
											{edu.coursework.map((course, i) => (
												<div
													key={i}
													className="flex items-center text-neutral-600 bg-neutral-100 px-3 py-2 rounded-lg"
												>
								...
								<div className="space-y-3">
									...
									<div className="flex items-center space-x-3">
										...
										<a
											...
											className="text-warm-600 hover:text-warm-700 transition-colors font-medium"
										>
											Devpost Profile
										</a>
									</div>
